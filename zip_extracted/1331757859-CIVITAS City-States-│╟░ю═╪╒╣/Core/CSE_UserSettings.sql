...
-----------------------------------------------
	...
	-- Melee
	('CS_START_WARRIOR',	2	), -- Number of additional Warrior units
...
-----------------------------------------------
	...
	('ENVOY_LIBERATE_MODERN',		6	), -- Game Default: 6
	('ENVOY_LIBERATE_ATOMIC',		6	), -- Game Default: 6
	('ENVOY_LIBERATE_INFORMATION',	6	), -- Game Default: 6
...
-----------------------------------------------
	...
	('MOMENT_FIRST_SUZERAIN',				3	), -- Game Default: 2
	('MOMENT_OUSTED_SUZERAIN_DURING_WAR',	3	), -- Game Default: 2
...
VALUES
	...
	('CSE_AGRICULTURAL',	'DISABLED',	1	),
	('CSE_CONSULAR',		'DISABLED',	1	), -- Requires XP1 or XP2 (Rise and Fall or Gathering Storm)
	('CSE_ENTERTAINMENT',	'DISABLED',	1	),
	('CSE_MARITIME',		'DISABLED',	1	),
