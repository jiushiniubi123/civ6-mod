...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 0.5, 0.651, 0.812);

UPDATE Technologies SET Cost = Cost*0.5;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*0.5;
