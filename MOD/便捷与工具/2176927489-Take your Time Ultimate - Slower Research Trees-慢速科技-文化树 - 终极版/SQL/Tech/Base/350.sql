...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 3.5, 2.174, 1.456);

UPDATE Technologies SET Cost = Cost*3.5;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*3.5;
