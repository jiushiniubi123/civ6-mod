...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 1.75, 1.415, 1.183);

UPDATE Technologies SET Cost = Cost*1.75;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*1.75;
