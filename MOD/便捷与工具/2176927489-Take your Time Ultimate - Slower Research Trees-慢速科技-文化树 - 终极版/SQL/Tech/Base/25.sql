...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 0.25, 0.423, 0.66);

UPDATE Technologies SET Cost = Cost*0.25;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*0.25;
