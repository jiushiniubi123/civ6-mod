...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 0.75, 0.837, 0.917);

UPDATE Technologies SET Cost = Cost*0.75;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*0.75;
