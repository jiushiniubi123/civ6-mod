...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 17.5, 5.898, 2.36);

UPDATE Technologies SET Cost = Cost*17.5;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*17.5;
