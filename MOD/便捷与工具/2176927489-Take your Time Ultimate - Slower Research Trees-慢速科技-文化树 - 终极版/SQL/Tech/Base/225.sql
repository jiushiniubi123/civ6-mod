...
INSERT INTO TakeYourTimeCostChanges VALUES ("Tech", NULL, NULL, 2.25, 1.653, 1.275);

UPDATE Technologies SET Cost = Cost*2.25;
...
UPDATE TechnologyRandomCosts SET Cost = Cost*2.25;
