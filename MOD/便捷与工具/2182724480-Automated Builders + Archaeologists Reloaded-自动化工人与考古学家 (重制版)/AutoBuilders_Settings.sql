...
-- General Options
REPLACE INTO CNO_AutoBuilders_Settings -- Don't touch this line!
...
VALUES 	-- Don't touch this line!
		...
		( 'MAX_Uniques_Ever',					100		);


-- Priority Settings
REPLACE INTO CNO_AutoBuilders_PrioritySettings -- Don't touch this line!
...
VALUES 	-- Don't touch this line!
		...
		-- Adriaman: added missing improvements and Gathering Storm improvements.
		-- If too many improvements are added, you need to increase the size of PrioritiesOptions_Panel_Container in AutoBuilders_LocalSettings_SettingsPanel.xml.
		( 'Improvement_Scoring',		'IMPROVEMENT_SEASTEAD',				    60		),
		( 'Improvement_Scoring',		'IMPROVEMENT_GEOTHERMAL_PLANT',			60		),
		( 'Improvement_Scoring',		'IMPROVEMENT_BEACH_RESORT',				50		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MINE',						40		),
		( 'Improvement_Scoring',		'IMPROVEMENT_FARM',						30		),
		( 'Improvement_Scoring',		'IMPROVEMENT_SOLAR_FARM',				20		),
		( 'Improvement_Scoring',		'IMPROVEMENT_WIND_FARM',				10		),
		( 'Improvement_Scoring',		'IMPROVEMENT_QUARRY',					0		),
		( 'Improvement_Scoring',		'IMPROVEMENT_FISHING_BOATS',			0		),
		( 'Improvement_Scoring',		'IMPROVEMENT_PASTURE',					0		),
		( 'Improvement_Scoring', 		'IMPROVEMENT_PLANTATION',				0		),
		( 'Improvement_Scoring', 		'IMPROVEMENT_CAMP',						0		),
		( 'Improvement_Scoring', 		'IMPROVEMENT_LUMBER_MILL',				0		),
		( 'Improvement_Scoring',		'IMPROVEMENT_FISHERY',					-5		), -- Governor improvement
		( 'Improvement_Scoring',		'IMPROVEMENT_CITY_PARK',				-10		), -- Governor improvement
		( 'Improvement_Scoring',		'IMPROVEMENT_OFFSHORE_WIND_FARM',		-20		), -- Make sure they are built last (prefer Seasteads)

		-- Improvements unique to a civilization or city-states
		( 'Improvement_Scoring',		'IMPROVEMENT_ALCAZAR',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_BATEY',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_CHATEAU',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_CHEMAMULL',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_COLOSSAL_HEAD',			0		), -- Colossal head gets a score less than other  unique improvements so it won't be chosen over them.
		( 'Improvement_Scoring',		'IMPROVEMENT_GOLF_COURSE',				5		),
		-- ( 'Improvement_Scoring',		'IMPROVEMENT_GREAT_WALL',				5		), -- Not supported
		( 'Improvement_Scoring',		'IMPROVEMENT_HACIENDA',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_ICE_HOCKEY_RINK',			5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_KAMPUNG',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_KURGAN',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MAHAVIHARA',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MEKEWAP',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MISSION',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MOAI',						5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MONASTERY',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MOUND',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_MOUNTAIN_ROAD',			5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_NAZCA_LINE',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_OPEN_AIR_MUSEUM',			5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_OUTBACK_STATION',			5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_PAIRIDAEZA',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_POLDER',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_PYRAMID',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_ROCK_HEWN_CHURCH',			5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_SPHINX',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_STEPWELL',					5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_TERRACE_FARM',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_TRADING_DOME',				5		),
		( 'Improvement_Scoring',		'IMPROVEMENT_ZIGGURAT',					5		),
		
		-- Distance: A lower number will have the Builder factor distance into the decision more.
		( 'Scoring',					'BUILDER_DISTANCE',						-6		),
