...
-- Suppress floating gossip and combat messages (they still appear in Notification Log if that mod is active)
    if (type == ReportingStatusTypes.GOSSIP or type == ReportingStatusTypes.DEFAULT) then
        return;
    end

-- CQUI custom types (CIVIC, TECHS) pass through and are converted to DEFAULT below
