...
function CityBanner.UpdateReligion(self)
	...
	if self.m_Instance.ReligionBannerIconContainer then
		LuaEvents.Suk_ReligionTT(self.m_Instance.ReligionBannerIconContainer, pCity:GetOwner(), pCity:GetID())
	--------------------------
	-- XP1+
	...
	--------------------------
		...
		if tSuk_ReligionInstanceButton then
			LuaEvents.Suk_ReligionTT(tSuk_ReligionInstanceButton, pCity:GetOwner(), pCity:GetID())
		end
	end
end
-- ===========================================================================
...
-- ===========================================================================
BASE_CityBanner_UpdateLoyalty = CityBanner.UpdateLoyalty

function CityBanner.UpdateLoyalty(self)
	BASE_CityBanner_UpdateLoyalty(self)
	tControl = self.m_InfoConditionIM.m_AllocatedInstances[1]
	if tControl then
		LuaEvents.Suk_CityBannerLoyaltyTT(tControl, self:GetCity())
	end
end
-- ===========================================================================
