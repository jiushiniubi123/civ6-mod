...
VALUES	('MODIFIER_SAILOR_WATCHTOWER_SIGHT_ADJUST', 'KIND_MODIFIER'),
		('MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',	'KIND_MODIFIER');

INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType)
VALUES	('MODIFIER_SAILOR_WATCHTOWER_SIGHT_ADJUST', 'COLLECTION_OWNER', 'EFFECT_ADJUST_UNIT_SIGHT'),
		('MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',	'COLLECTION_OWNER',	'EFFECT_CHANGE_UNIT_OPERATION_AVAILABILITY');
...
VALUES	('ABILITY_SAILOR_WATCHTOWER_MAJOR_SIGHT_BONUS', 'SAILOR_WATCHTOWER_MAJOR_SIGHT_MOD'),
		...
		-- UnitOperations
		('ABILITY_SAILOR_WATCHTOWER_DISABLE_OPS',		'SAILOR_WATCHTOWER_DISABLE_PLANT'),
...
VALUES	('SAILOR_WATCHTOWER_MAJOR_SIGHT_MOD',			'MODIFIER_SAILOR_WATCHTOWER_SIGHT_ADJUST',			'SAILOR_WATCHTOWER_PLOT_REQUIREMENT'),
		...
		-- UnitOperations
		('SAILOR_WATCHTOWER_DISABLE_PLANT',				'MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',			NULL),
		('SAILOR_WATCHTOWER_DISABLE_DECONTAMINATE',		'MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',			NULL),			
		('SAILOR_WATCHTOWER_DISABLE_HARVEST',			'MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',			NULL),			
		('SAILOR_WATCHTOWER_DISABLE_FEATURE_REMOVAL',	'MODIFIER_SAILOR_WATCHTOWER_DISABLE_OPS',			NULL);

INSERT OR REPLACE INTO ModifierArguments
		(ModifierId,									Name,				Value)
VALUES	('SAILOR_WATCHTOWER_MAJOR_SIGHT_MOD',			'Amount',			3),
		('SAILOR_WATCHTOWER_TREELINE_MOD',				'CanSee',			3),
		('SAILOR_WATCHTOWER_MINOR_SIGHT_MOD',			'Amount',			1),
		('SAILOR_WATCHTOWER_DISABLE_PLANT',				'OperationType',	'UNITOPERATION_PLANT_FOREST'),
